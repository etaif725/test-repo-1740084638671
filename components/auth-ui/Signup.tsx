...
export default function SignUp({ allowEmail, redirectMethod }: SignUpProps) {
  ...
  return (
    <div className="mb-8">
      ...
      >
        <div className="grid gap-2">
          <div className="grid gap-1">
            <label className="text-zinc-950 dark:text-white" htmlFor="full_name">
                Full Name
              </label>
              <Input
      ...
      {/* <p>
        <Link
          href="/dashboard/auth/forgot_password"
      ...
      <p className="font-medium text-sm dark:text-white">
        <Link
          href="/dashboard/auth/password_signin"
      ...
      {/* {allowEmail && (
        <p className="font-medium text-sm dark:text-white">
          <Link
            href="/dashboard/auth/email_signin"
            className="font-medium text-sm dark:text-white"
          >
