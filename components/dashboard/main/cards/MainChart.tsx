  ...
  return (
    <Card className={'border-zinc-200 p-6 dark:border-zinc-800 w-full'}>
      <div className="flex items-center gap-3">
        <div className="flex h-14 w-14 items-center justify-center rounded-full border border-zinc-200 text-4xl dark:border-zinc-800">
          <HiChartBar className="h-5 w-5 text-black dark:text-white" />
        </div>
        <div>
